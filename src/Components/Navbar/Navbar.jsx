    ...
    <div className="header">
      <nav className={`navbar ${sticky ? "dark-nav" : ""}`}>
        ...
        <ul className={mobileMenu ? "" : "hide-mobile-menu"}>
          ...
          <button class="group relative mx-5 h-12 w-44 overflow-hidden rounded-lg bg-white text-xl shadow-lg shadow-cyan-500/50">
          ...
          <div
            id="dropdownHover"
            class="z-10 hidden divide-y divide-gray-100 rounded-lg shadow w-44 shadow-lg shadow-cyan-500/40 dark:bg-gray-700 box-shadow-custom"
          >
            <ul
            ...
            >
              <li>
                <a
                  href="#"
                  class="block px-4 py-2 hover:bg-blue-400 dark:hover:bg-gray-600 dark:hover:text-white"
                >
                  English
                </a>
              </li>
